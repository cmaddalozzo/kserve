    ...
    def create_application(self) -> FastAPI:
        ...
        return FastAPI(
            ...
            routes=[
                ...
                FastAPIRoute(r"/v2/models/{model_name}/generate",
                             v2_endpoints.generate, methods=["POST"], tags=["V2"]),
                FastAPIRoute(r"/v2/models/{model_name}/generate_stream",
                             v2_endpoints.generate_stream, methods=["POST"], tags=["V2"]),
                ...
                # OpenAI Protocol
                FastAPIRoute(r"/v1/chat/completions",
                             openai_model.create_chat_completion, methods=["POST"], tags=["OpenAI"]),
                FastAPIRoute(r"/v1/completions",
                             openai_model.create_completion, methods=["POST"], tags=["OpenAI"]),
            ], exception_handlers={
